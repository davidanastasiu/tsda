...
PretrainedConfig._get_non_default_generation_parameters = lambda self: {}
####
try:
...
# Split based on dataset name
    train_dataset = ConcatDataset([
        ds for ds in all_datasets.datasets if ds.ds_name == "vlm-train"
     ])
    eval_dataset = ConcatDataset([
        ds for ds in all_datasets.datasets if ds.ds_name == "vlm-val"
     ])
