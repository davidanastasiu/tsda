...
OUTPUT_DIR='work_dirs/internvl_chat_v3/mid_bdd_vqa'
...
torchrun \
  ...
  --meta_path "/WAVE/dmlab/ridham/AICITY_Track2_dmlab/InternVL/internvl_chat/shell/data/aic_new_data_bdd_only.json" \
