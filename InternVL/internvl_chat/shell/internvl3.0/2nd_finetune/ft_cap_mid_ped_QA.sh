...
OUTPUT_DIR='work_dirs/internvl_chat_v3/mid_ped_QA'
...
torchrun \
  ...
  --meta_path "/WAVE/dmlab/ridham/AICITY_Track2_dmlab/InternVL/internvl_chat/shell/data/aic_new_cap_ped.json" \
