...
BDD_ANNO_DIR="$DATA_DIR/WTS/final_annotations_WTS/BDD_anno" # Note: BDD annotations are nested under WTS
...
# Output directories
WTS_OUTPUT_DIR="$PROJECT_ROOT/WTS_even_frames"
BDD_OUTPUT_DIR="$PROJECT_ROOT/BDD_even_frames"
...
python -m extract.preprocess_evenly \
  --dataset WTS \
  --split train \
