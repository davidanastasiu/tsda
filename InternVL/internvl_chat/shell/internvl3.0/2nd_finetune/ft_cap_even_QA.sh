...
OUTPUT_DIR='work_dirs/internvl_chat_v3/even_cap_qa'
...
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True
  ...
  --meta_path "/WAVE/dmlab/ridham/AICITY_Track2_dmlab/InternVL/internvl_chat/shell/data/aic_caption_features.json" \
