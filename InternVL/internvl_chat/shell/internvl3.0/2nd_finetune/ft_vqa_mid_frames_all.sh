...
OUTPUT_DIR='work_dirs/internvl_chat_v3/mid_all_vqa'
...
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True
  ...
  --meta_path "/WAVE/dmlab/ridham/AICITY_Track2_dmlab/InternVL/internvl_chat/shell/data/aic_new_data_full.json" \
